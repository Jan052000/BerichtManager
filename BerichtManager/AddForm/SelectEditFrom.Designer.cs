namespace BerichtManager.AddForm
{
	partial class SelectEditFrom
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbEditStartDate.TabIndex = 2;
			...
			this.cbEditSeminars.TabIndex = 6;
			...
			this.laInstructions.TabIndex = 12;
